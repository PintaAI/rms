...
interface InventoryOverviewProps {
  ...
  initialPricelists: InventoryPricelist[];
  tokoId: string;
  tokoName: string;
}
...
export function InventoryOverview({
  ...
  const [editingPricelist, setEditingPricelist] = useState<InventoryPricelist | null>(null);
  ...
  const openPricelistDialog = (pricelist?: InventoryPricelist) => {
    setEditingPricelist(pricelist || null);
    setPricelistDialogOpen(true);
  };

  const openDeleteDialog = (type: "sparepart" | "pricelist", id: string, title: string) => {
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Manage spareparts available for repairs</CardDescription>
              </div>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              variant="ghost"
                              size="icon-sm"
                              onClick={() => openDeleteDialog("sparepart", sparepart.id, sparepart.name)}
                            >
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Manage service types and their default prices</CardDescription>
              </div>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              variant="ghost"
                              size="icon-sm"
                              onClick={() => openDeleteDialog("pricelist", pricelist.id, pricelist.title)}
                            >
                              <RiDeleteBinLine className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
